...
var formSubmitHandler = function (event) {
    ...
    var searchName = searchInputEl.value.trim();
...
var getUserRepos = function (searchTerm) {
    var apiUrl = 'https://www.loc.gov/collections/' + searchTerm + '?fo=json';
...
var displayRepos = function (repos, searchTerm) {
    ...
    for (var i = 0; i < repos.length; i++) {
        ...
        // TODO: Write your answer here
        var repoName = repos[i].url;
        //  + '/' + repos[i]._featured_news.title;
